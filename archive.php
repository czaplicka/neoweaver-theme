...
<main class="neo-terminal-container neo-archive"><div class="neoweave-terminal">
                    ...
                    <div class="neo-entry-main">
                        <h2 class="neo-entry-title">
                            <a href="<?php the_permalink(); ?>">
                                <span class="neo-arrow">></span> <div class="terminal-title"><?php the_title(); ?></div>
                            </a>
                        </h2>
                        ...
                        <div class="neo-entry-tags">
                            <div class="terminal-section-title"><span class="neo-label">FOLDER:</span> <?php the_category( ' ' ); ?></div>
                            <?php if(has_tag()) : ?>
                               <div class="neoweave-tag"><span class="neo-label">// TAGS:</span> <?php the_tags( '', ' ', '' ); ?></div>
                            <?php endif; ?>
                        </div>
                    </div>
